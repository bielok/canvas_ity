...
public:
    ...
    void render() {
        ...
        // Add more key tiger parts (simplified version)
        that.begin_path();
        that.set_line_width( 0.133333f );
        ...
        // Tiger face/head area
        that.begin_path();
        that.set_line_width( 0.133333f );
        that.set_color( canvas_ity::fill_style, 0.8f, 0.45f, 0.15f, 1.0f );
        that.move_to( 400.0f, 200.0f );
        that.bezier_curve_to( 450.0f, 180.0f, 500.0f, 220.0f, 480.0f, 280.0f );
        that.bezier_curve_to( 460.0f, 340.0f, 400.0f, 320.0f, 380.0f, 280.0f );
        that.bezier_curve_to( 360.0f, 240.0f, 380.0f, 200.0f, 400.0f, 200.0f );
        that.fill();
        ...
        that.move_to( 410.0f, 240.0f );
        that.arc( 410.0f, 240.0f, 8.0f, 0.0f, 6.28318f );
        that.fill();
        
        that.move_to( 450.0f, 240.0f );
        that.arc( 450.0f, 240.0f, 8.0f, 0.0f, 6.28318f );
        that.fill();
    }
